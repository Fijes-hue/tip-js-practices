...
| Number("text")   | Nan                 | Nan                  | Number         | Текст не возможно представить в виде числа   |
...
| Проверка | Входные данные | Ожидаемый результат | Фактический результат | Итог |
|---|---|---|---|---|
| Обычный случай | 12 5 3 | 3 дня; в последний день выполнена 1 задача. | 3 дня; в последний день выполнена 1 задача. | Осталось задач: 7 День 1: выполнено 3, осталось 4 День 2: выполнено 3, осталось 1 День 3: выполнено 1, осталось 0 Потребуется дней: 3 |
| Обычный случай | 10 4 3 | 2 дня, по 3 задачи в день. | 2 дня, по 3 задачи в день. | Осталось задач: 6 День 1: выполнено 3, осталось 3 День 2: выполнено 3, осталось 0 Потребуется дней: 2 |
| Обычный случай | 5 3 10 | 1 день, выполнено только 2 оставшиеся задачи. | 1 день, выполнено только 2 оставшиеся задачи. | Осталось задач: 6 День 1: выполнено 3, осталось 3 День 2: выполнено 3, осталось 0 Потребуется дней: 2 |
| Граничный случай | 5 5 2 | 0 дней; цикл не выполняется. | 0 дней | Все задачи уже выполнены Потребуется дней: 0 |
| Граничный случай | 0 0 2 | 0 дней; цикл не выполняется. | 0 дней | Все задачи уже выполнены Потребуется дней: 0 |
| Некорректные данные | 5 2 0 | Ошибка; цикл не запускается. | Ошибка: некорректные данные | Ошибка: некорректные данные |
| Некорректные данные | 5 2 1.5 | Ошибка: дробной дневной нормы быть не должно. | Ошибка: значения должны быть целыми числами | Ошибка: значения должны быть целыми числами |
| Некорректные данные | 5 6 2 | Ошибка: некорректное число выполненных задач. | Ошибка: некорректные данные | Ошибка: некорректные данные |
| Некорректные данные | 5 2 "2" | Ошибка: дневная норма задана строкой. | Ошибка: значения должны быть целыми числами | Ошибка: значения должны быть целыми числами |
| Некорректные данные | 5 2 1001 | Ошибка: превышена верхняя граница нормы. | Ошибка: некорректные данные | Ошибка: некорректные данные |
